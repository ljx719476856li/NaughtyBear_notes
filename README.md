...
因为，union变量所占用的内存长度等于最长的成员的内存长度，也就是union联合体将不同类型的变量存放在同一个地址开始的内存单元中，也就是使用的覆盖技术，变量间相互覆盖。
...
```
如果对union还存在疑惑，可以参考下述文章👇  
[union介绍](https://www.cnblogs.com/jeakeven/p/5113508.html)  
...
### 图形渲染管线
![客户端服务器通讯](https://github.com/ljx719476856li/NaughtyBear_notes/blob/master/summary/Img/图形渲染管线.png)
